  ...
  return (
    <section className="px-6 sm:px-12 md:px-16 py-10 sm:py-14" id="music">
      ...
      <div className="flex items-center gap-4 mb-6">
        <h2 className="section-label">Plataformas</h2>
      ...
      <div className="space-y-px">
        {LINKS.map((link, i) => (
          <a
            ...
            className="group flex items-center justify-between py-6 sm:py-8 border-b transition-colors duration-200 cursor-pointer"
            style={{ borderColor: 'var(--color-line)', minHeight: '44px' }}
          >
